...
import "./StoreMenuBoardWrite.css";
import Swal from "sweetalert2";

const StoreMenuBoardWrite = ({ handlelist }) => {
  ...
  return (
    <div>
      ...
      <br />
      <h1 className="logo4">메뉴 등록</h1>
      {/* <td width="100px">메뉴 사진</td> */}
      <div className="boardwrite_input">
        <input
          type="file"
          name="image"
          ref={imageRef}
        ...
        ></input>
        &nbsp;
        <input type="reset" value="취소" className="menucancle"></input>
      </div>
    </div>
  );
};

export default StoreMenuBoardWrite;
